...
<body>
 	<div class="container" style="margin-top:100px">
 		<h2><span class="shadow p-3 mb-5 bg-white rounded text-success " > You have visited <a href="/"><c:out value="${www }"/></a> <c:out value="${count }"/> times.</span></h2>
 		<h2 style="margin-top:100px"><span class="shadow p-3 mb-5 bg-white rounded text-success " > <a href="/">Test another Visit</a></span></h2>
 		<h3 style="margin-top:100px"><span class="shadow p-3 mb-5 bg-white rounded text-success " ><a href="/add2">Add 2 to your Count</a></span></h3>
